...
// Recebe { html } no body, devolve PDF gerado
app.post('/api/gerar-pdf', async (req, res) => {
  ...
  let browser = null;
  try {
    // Launch Puppeteer (no Railway, use argumentos extras para rodar em ambiente cloud)
    ...
    // Gera o PDF (você pode customizar formato, margem etc)
